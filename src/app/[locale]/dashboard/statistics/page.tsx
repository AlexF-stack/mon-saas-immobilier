...
export default async function DashboardStatisticsPage(props: {
  ...
  const dashboardTitle = role === 'MANAGER' ? 'Statistiques manager' : 'Statistiques administrateur'
  const dashboardDescription = isAdmin
    ? 'Vue globale de la plateforme: revenus, occupation, contrats actifs et activite recente.'
    : 'Vue analytique de votre portefeuille immobilier: revenus, disponibilites et echeances.'
