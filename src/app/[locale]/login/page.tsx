...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-accent/10 to-secondary/20 dark:from-primary/10 dark:via-accent/5 dark:to-background" />
            ...
            <Card className="w-full max-w-md mx-4 relative z-10 bg-white/90 dark:bg-slate-900/85 backdrop-blur-sm border-2 border-primary/20 shadow-2xl shadow-primary/10">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input 
                                    ...
                                    required 
                                    className="pl-10 bg-white dark:bg-background border-2 border-primary/20 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                                />
