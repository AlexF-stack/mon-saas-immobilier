  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-[rgb(var(--text-secondary))]",
        className
      )}
      {...props}
    >
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("px-2 py-1.5 text-xs uppercase tracking-wide text-secondary", className)}
      {...props}
    />
  )
}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "[&_svg:not([class*='text-'])]:text-[rgb(var(--text-secondary))] *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
